...
### Страница проекта
![Страница проекта](music_management/screenshots/project.png)

### Аудиоплеер с маркерами комментариев
![Аудиоплеер](music_management/screenshots/track.png)

### Страница задач с открытым окном уведомлений
![Задачи с уведомлениями](music_management/screenshots/tasks-notifications.png)
